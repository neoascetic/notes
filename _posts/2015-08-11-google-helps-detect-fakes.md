...
Накануне семидесятой годовщины [бомбардировок Хиросимы и Нагасаки][H&N] я попал
на [этот пост][crap-post] (на  всякий случай вот [ссылка][crap-post-archive] на
архивированную  версию).  Там,  после  весьма  пугающего  описания  того,  что,
...
Читал  я это,  смотрел картинки,  скрипел зубами  от осознания,  какие все-таки
...
собрался убрать открытое в результате выполнения первого шага контекстное меню,
как  вдруг  увидел  в нем  пункт  "Искать  в  Гугле  по изображению".  Да,  вот
так  сразу,  шаги  со  второго  по  восьмой  включительно  заменяются  на  клик
по  этому  пункту  меню!  Оказывается,  со времён  моего  ухода  [по  некоторым
причинам][chromium-wontfix-post]  на Файрфокс  корпорация  добра добавила  этот
пункт меню при клике на картинки.

![](/images/google-helps-detect-fakes.jpg)
...
[google-calc]: https://www.google.com/search?q=2015+-+1954+%2B+18
